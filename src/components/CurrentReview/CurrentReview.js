        ...
        <div className="current-reviews">
            <div className="indv-review">
                ...
                <p className="description-text">
                    ...
                    ut officia molestiae tempore iste vel odio quas enim quae?
                    Voluptatum necessitatibus odio reprehenderit, molestias
                    nihil labore amet optio doloremque temporibus.
                </p>
                <hr />
            </div>
            <div className="indv-review">
